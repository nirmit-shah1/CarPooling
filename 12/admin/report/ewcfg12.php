...
define("EW_PROJECT_ID", "{9ACD0C53-10B4-423E-B4D2-BB7755A0F8CA}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'w8ABj7Ww5bfc0Kuc', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "project", "qs" => "`", "qe" => "`");
