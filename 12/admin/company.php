...
<!--<div align="right"><a href="../main login/logout.php">Logout</a></div>-->
	...
	<form action="companyback.php" method="post">
		<h2 align="center"><font color="#009900" size="+4">Add Company</font></h2>
...
<td></td>
	...
	?>
		 ...
		 <a href="admin.php"><font color="#990000" size="+2"><-Back To Area Registration Page</font></a>
		 </div>
	</body>
	</html>
<?php
