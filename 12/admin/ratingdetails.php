...
<form action="rating.php" method="post">
                        ...
                        <label class = "full" for="star5" title="Awesome to travel with him - 5 stars"></label>
                        ...
                        <label class="half" for="star3half" title="enjoyed to travel with- 3.5 stars"></label>
                        ...
                        <label class = "full" for="star2" title="boring to travel with him - 2 stars"></label>
                        <input class="stars" type="radio" id="star1half" name="rating" value="1.5" />
                        <label class="half" for="star1half" title="fair to travel with him - 1.5 stars"></label>
                        <input class="stars" type="radio" id="star1" name="rating" value="1" />
                        <label class = "full" for="star1" title="not like to travel with him - 1 star"></label>
