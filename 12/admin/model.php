...
<h2 align="center"><font color="#009900" size="+4">Add vehicle company model </font></h2>
...
<br /><br /><br /><br />
<table width="807" cellspacing="10" cellpadding="10">
	<tr>
...
<?php
	...
	$result1=mysql_query("select * from model ORDER BY coid ASC");
