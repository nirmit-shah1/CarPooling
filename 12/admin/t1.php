	...
	<div id="content">
		<div id="sidebar">
			<div class="box">
				...
				<ul id="home">
					<li class="b1"><a class="icon view_page" href="../index1.html">Visit site</a></li>
		...
		<div id="main">
			...
			<div class="full_w">
				<div class="h_title">Registration</div>
				<?php
	//session_start();
...
?>
	...
	<ul><br /><br /><br />
	<li><font color="#006600" size="+2"><a href="state.php">Register State</a></li><br />
	<li><a href="city.php">Register City</a></li><br />
	<li><a href="area.php">Register Area</a></li><br />
	<li><a href="company.php">Register Vehicle company</a></li><br />
	<li><a href="model.php">Register Vehilce Model</a></li></font></ul>
</font>
<?php /*}
else
