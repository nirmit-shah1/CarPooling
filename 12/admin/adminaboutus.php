...
//aboutushorizantalmenu.php");
?>
<html>
<body>
<p style="background-image:url(img/323a45-2880x1800.png)"><font color="#FFFFFF" size="+5">Information About Car Pooling</font></p>
<div class="boxinfo">
<ol>
...
<li> Many people will like to use Car Poolingevery quarter creating an entirely new, people powered, transport network.</li><br>
...
<li>With help of Car Pooling the enviroment can also be protected from the harmful gases that emitted from the vehicle.</li><br>
