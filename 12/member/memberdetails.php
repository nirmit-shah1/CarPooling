<?php  include_once("../toptemplate.php");
 ?>
<body>
<table>
<form action="memberdetailsback.php" enctype="multipart/form-data" method="post">
  <tr>
	<td colspan="2" style="padding-left:100px">Your Cars Details</td></tr><tr><td>&nbsp;</td></tr>
  <tr>
  <td height="59">category:</td>
  	<td align="left">  <select name="selcategory">
   ...
   <td height="63">Number of seat available:</td>
	<td align="left" ><select name="selseat" style="border-color:#999900" >
	<option value="--select--">--select--</option>
  ...
  <p>
    ...
    <td align="left"> <select name="selcolor">
	<option value="--select--">--select--</option>
